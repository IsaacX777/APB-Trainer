...
for set in algs['lxs']:
    ...
    for i, alg in enumerate(algs['lxs'][set]):
        ...
        if not os.path.isfile(image_filename):
            image_url = f'https://visualcube.api.cubing.net/visualcube.php?fmt=png&size=200&pzl=3&stage=f2l&case={alg}&bg=white'
...
#             image_url = f'https://visualcube.api.cubing.net/visualcube.php?fmt=png&size=200&pzl=3&fd={cube_string.lower()}&bg=white'
#             response = requests.get(image_url)
